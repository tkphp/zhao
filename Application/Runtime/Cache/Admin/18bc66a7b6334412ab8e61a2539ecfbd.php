      ...
      <div class="am-u-sm-12 am-u-md-3">
        <div class="am-form-group">
          <select data-am-selected="{btnSize: 'sm'}">
            ...
            <option value="option2">已取消</option>
            <option value="option3">等待付款</option>
            <option value="option3">等待发货</option>
            <option value="option3">已发货</option>
      ...
      <div class="am-u-sm-12">
        <form class="am-form" action="<?php echo U('Goods/delete');?>" method="post">
          ...
          <?php if(is_array($orders)): foreach($orders as $key=>$order): ?><tr>
              <td><input  type="checkbox" /><input type="hidden" value="<?php echo ($order["id"]); ?>"></td>
