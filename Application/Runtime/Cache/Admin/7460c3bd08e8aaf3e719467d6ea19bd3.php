      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group am-btn-group-xs">
            <a href="<?php echo U('Goods/add');?>"><button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</button></a>
      ...
      <div class="am-u-sm-12">
        <form class="am-form" action="<?php echo U('Goods/delete');?>" method="post">
          ...
          <?php if(is_array($goods)): foreach($goods as $key=>$good): ?><tr>
              ...
              <td><a href="#"><?php echo ($good["name"]); ?></a></td>
              <td>default</td>
              <td class="am-hide-sm-only"><?php echo ($good["price"]); ?></td>
              <td class="am-hide-sm-only"><?php echo ($good["num"]); ?></td>
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
