...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">商品添加</strong> <small></small></div>
    </div>

    <div class="am-g">
	<form action="<?php echo U('Goods/doAdd');?>" method="post" enctype="multipart/form-data">
        ...
        <div class="am-form am-form-horizontal">
          <div class="am-form-group">
 		  ...
 		  <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="password" id="password" placeholder="商品类别" required>
              <small></small>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="price" name="price" placeholder="商品价格" required>
              <small></small>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="num" name="num" placeholder="库存量" required>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea class="" rows="5" id="description" name="description" placeholder="商品描述" required></textarea>
              <small></small>
            </div>
          </div>
