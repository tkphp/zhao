...
<script src="/zhao/Public/assets/js/jquery.min.js"></script>
<script src="/zhao/Public/assets/js/amazeui.min.js"></script>
	...
	function check_mobile(){
		...
		$("#mobile").bind("blur",function(){
		    ...
		    if(emailreg.test($mobile)){    
				...
				$("#reg_form").attr("action","<?php echo U('User/doEmailChange');?>");
				...
				$("#reg_form").attr("action","<?php echo U('User/doTelChange');?>");
				$.post('<?php echo U('User/chk');?>', {mobile:$mobile}, function(data) {
					if(data){
						$("#span1").html('<i class="am-icon-check-square"></i>').css("vertical-align","middle");
					}else{
